    ...
    if len(text)>7:
        ...
        for msg in messages:
            ...
            if bool(CUSTOM_CAPTION) & bool(msg.document):
                ...
                caption = CUSTOM_CAPTION.format(previouscaption = "" if not msg.caption else msg.caption.html, filename = msg.caption)
                ...
                reply_markup = InlineKeyboardMarkup(
                    [
                        ...
                        InlineKeyboardButton(
                            ...
                            url = f"https://t.me/addlist/p002A-sAuIxjYzA9"
                            )
                        ],
                        [
                        InlineKeyboardButton(
        ...
        reply_markup = InlineKeyboardMarkup(
            [    
                [
                    InlineKeyboardButton("🔰Join Our Movie Channel🔰",url = f"https://t.me/addlist/p002A-sAuIxjYzA9")
                ],
                [
